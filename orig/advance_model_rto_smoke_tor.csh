...
while($state_copy <= $num_states)
   ...
   #while ( $wrfkey < $targkey )
      ...
      set INTERVAL_SS = '900' #`expr ${assim_per_conv} \* 60`  # WILL NEED TO BE CHANGED WITH CYCLING <15MIN; MAKE THIS A DYNAMIC VARIABLE (4/23/24)
      ...
      set INTERVAL_MIN = '15' #`expr $INTERVAL_SS \/ 60`
