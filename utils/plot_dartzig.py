...
if __name__ == "__main__":
    ...
    if wargs.obstype == "list":
        ...
        for item in os.listdir(wargs.run_dir):
            rematch1 = re.match(f'obs_seq.nc.{wargs.eventdate}([12][0-9][0-5][05])',item)
            rematch2 = re.match(f'obs_seq.nc.{nextdatestr}(0[0-9][0-5][05])',item)
            if rematch1:
