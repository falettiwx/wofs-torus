...
# --------------------------------------------------
set start_g_date = `${EXEDIR}/convertdate | tail -1 | cut -d: -f2` << EOF
1
...
echo '#SBATCH' "-J mem${emember}/cycle_${ICYC}/icbc_1h_${ICYC}"                   >> ${RUNDIR}/ic${emember}/cycle_1h_${ICYC}/icbc_1h_${ICYC}.csh
